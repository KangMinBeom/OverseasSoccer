...
<div class="container">
    <header class="d-flex justify-content-center py-3">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="/League/leagueang" class="nav-link active"><img src="/image/leagueang.png" height="30" width="30"/>리그앙</a></li>
...
<table>
        <tbody>
                ...
                <c:forEach var="SoccerDTO" items="${list4}">
                <tr>
